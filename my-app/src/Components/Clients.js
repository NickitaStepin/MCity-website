    ...
    return (
      <div>
        <Container className="ms-50">
            ...
            <img src={fon} style={{position:"relative", marginLeft:"-300px"}}/>
        </Container>
        <Container className="ms-50">
           ...
           клиентов. Со многими из них мы работаем на постоянной основе</p>
            <img src={Plenka1} style={{position:"absolute", marginTop:"170px",marginLeft:"90px"}}/>
            <img src={Plenka2} style={{position:"absolute", marginTop:"170px",marginLeft:"670px"}}/>
            <img src={Plenka3} style={{position:"absolute", marginTop:"470px",marginLeft:"90px"}}/>
            <img src={Plenka4} style={{position:"absolute", marginTop:"470px",marginLeft:"670px"}}/>
            <img src={Plenka5} style={{position:"absolute", marginTop:"770px",marginLeft:"90px"}}/>
            <img src={Plenka6} style={{position:"absolute", marginTop:"770px",marginLeft:"670px"}}/>
            <img src={Plenka7} style={{position:"absolute", marginTop:"1070px",marginLeft:"90px"}}/>
            <img src={Plenka8} style={{position:"relative", marginTop:"1070px",marginLeft:"670px"}}/>
        </Container>
        <Container className="ms-50">
            <img src={BlackDots} style={{position:"absolute",marginLeft:"-150px"}} />
            <img src={Shy}style={{position:"absolute",marginLeft:"-200px", marginTop:"-230px",zIndex:"-1"}} />
            <img src={Mask}style={{position:"absolute",marginLeft:"50px", marginTop:"100px", zIndex:"1"}} />
            <img src={BlackFon} style={{position:"absolute",marginLeft:"-330px", marginTop:"550px", height:"550px"}} />
            ...
            <Carousel1 style={{position:"relative",marginLeft:"200px"}}/>
        </Container>
        <Container className="ms-50">
