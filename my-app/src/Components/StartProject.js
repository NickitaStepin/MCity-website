    ...
    return (
      <div>
        <Container className="ms-50">
            ...
            <img src={Shapka} alt="/" style={{position:"relative", marginLeft:"-300px", marginTop:"-150px"}}/>
        </Container>
        <Container className="ms-50">
        ...
        <Container className="ms-50">
            <img src={Samuray} alt="/" style={{position:"absolute", marginLeft:"-300px", marginTop:"70px"}} />
        ...
        <Container className="ms-50">
            ...
            <Row style={{position:"absolute", marginTop:"280px"}}>
                ...
                Landing Page</h1>
                <a href="/" ><img src={Order}alt="/" style={{position:"absolute", marginTop:"450px", marginLeft:"-550px"}}/></a>
...
Сайт «цепляет» посетителя с первых секунд и ведет к целевому действию (покупке, регистрации, заявке) — через преимущества, подробные описания и видеоролики к форме заказа и контактам.
        ...
        <Container>
            <img src={Fon3} alt="/" style={{position:"relative", marginTop:"1400px", marginLeft:"-300px"}}/>
            ...
            <Row style={{marginTop:"-300px"}}>
                <Col>
                <img src={InYan} alt="/" style={{position:"absolute",zIndex:"2"}} />
            ...
            <Row style={{marginTop:"130px"}}>
                ...
                <img src={InYan} alt="/" style={{position:"relative",zIndex:"2"}}/>
                </Col>
            </Row>
        </Container>
        <Container className="ms-50">
